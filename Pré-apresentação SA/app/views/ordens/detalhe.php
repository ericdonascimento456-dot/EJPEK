    ...
    <tr>
      ...
      <td>
        <button class="am-btn am-btn-muted am-btn-sm" disabled
                title="Disponível na versão final" style="cursor:not-allowed;opacity:.45">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
  ...
  <div class="am-card" style="margin-bottom:0;border-color:rgba(139,148,158,.2);opacity:.7">
    <div class="am-card-header"><i class="bi bi-hourglass-split" style="color:var(--am-muted)"></i> Finalizar OS</div>
    <div style="padding:.75rem;background:rgba(139,148,158,.07);border-radius:8px;border:1px dashed rgba(139,148,158,.3)">
      <div style="font-size:.8rem;color:var(--am-muted);text-align:center;line-height:1.6">
        <i class="bi bi-tools" style="font-size:1.4rem;display:block;margin-bottom:.4rem"></i>
        <strong style="color:var(--am-text)">Em desenvolvimento</strong><br>
        A finalização de OS estará disponível na versão final do sistema.
      </div>
    </div>
  </div>
</div>
